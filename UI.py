...
from ConstructBoard import ConstructGrid
...
class HomePage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.img = ImageTk.PhotoImage(Image.open("defimg.png").resize((490, 450), Image.LANCZOS))
    ...
    def open_img(self):
        ...
        img = img.resize((490, 450), Image.LANCZOS)
...
class StagesFrame(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.img = ImageTk.PhotoImage(Image.open("defimg.png").resize((490, 490), Image.LANCZOS))
        self.imgpanel = Label(self, image=self.img)
    ...
    def setselectedimgpath(self):
        ...
        img = ImageTk.PhotoImage(Image.open(self.initimagepath).resize((490, 490), Image.LANCZOS))
        self.imgpanel.configure(image=img)
        self.img = img
    ...
    def back(self):
        ...
        img = ImageTk.PhotoImage(Image.open(currstageimgpath).resize((490, 490), Image.LANCZOS))
        self.imgpanel.configure(image=img)
        self.img = img
